...
const AnimatedText = () => {
    ...
    return (
        <span className={`inline-block transition-all duration-400 ${isAnimating ? 'opacity-0 transform translate-y-2' : 'opacity-100 transform translate-y-0'}`}>
            <span className="bg-gradient-to-r from-white via-blue-50 to-blue-100 bg-clip-text text-transparent font-extrabold">
...
const HomePage = () => {
    ...
    return (
        <div className='relative min-h-screen bg-white overflow-hidden'>
            ...
            {/* NEW BUILD YOUR PC SECTION - OPTIMIZED */}
            <div className='relative bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 py-16 sm:py-20 md:py-24 lg:py-32 xl:py-40 min-h-[85vh] sm:min-h-[80vh] flex items-center'>
                ...
                <div className='relative z-10 max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 w-full'>
                    ...
                    <div className='text-center mb-12 sm:mb-16 lg:mb-20'>
                        <h2 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold text-white mb-3 leading-tight'>
                            We Build PCs for
                        </h2>
                        <div className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold mb-6 sm:mb-8 min-h-[1.2em] flex items-center justify-center'>
                            <AnimatedText />
                        </div>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-6 lg:gap-8 mb-10 sm:mb-12 lg:mb-16 max-w-6xl mx-auto'>
                        {/* Stat 1 */}
                        <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-6 sm:p-7 lg:p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 group'>
                            ...
                            <div className='text-sm sm:text-base lg:text-lg text-blue-100 font-medium whitespace-nowrap'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-10'>
                        {/* Office PCs */}
                        <div className='bg-white rounded-2xl p-8 sm:p-10 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1'>
                            <div className='w-14 h-14 sm:w-16 sm:h-16 bg-blue-100 rounded-xl flex items-center justify-center mb-5'>
                            ...
                            <h3 className='text-xl sm:text-2xl font-bold text-gray-900 mb-3'>Specialized Office PCs</h3>
                        ...
                        <div className='bg-white rounded-2xl p-8 sm:p-10 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1'>
                            ...
                            <h3 className='text-xl sm:text-2xl font-bold text-gray-900 mb-3'>High-Performance Gaming</h3>
                            <p className='text-base sm:text-lg text-gray-600 leading-relaxed'>
                        ...
                        <div className='bg-white rounded-2xl p-8 sm:p-10 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1'>
                            ...
                            <h3 className='text-xl sm:text-2xl font-bold text-gray-900 mb-3'>Professional Rendering</h3>
                            <p className='text-base sm:text-lg text-gray-600 leading-relaxed'>
            ...
            <div className='relative z-10 max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-12 lg:py-16'>
                ...
                {/* Categories Section with Custom Desktop Layout */}
             <section className='relative py-16 sm:py-20 lg:py-24 bg-white'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    ...
                    {/* Category Grid - Mobile: 1 column, Desktop: 2+3 layout */}
                    <div className='space-y-8 lg:space-y-10'>
                        {/* First Row - 2 items on Desktop */}
